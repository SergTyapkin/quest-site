...
const butovoNaikitas = require("./quests/Квест по Бутово (ДР Никиты 2021).js");
...
app.get('/api/quest', (req, res) => {
    ...
    for (const quest of quests)
        if (!quest.users || (user in quest.users) || user.admin)
